 ...
 * the pager offers it, in the shape less asks about a binary file.
 */
describe('the offer to finish a search with POSIX', () => {
  it('asks in less\'s own question shape', () => {
    posixRetry.pending = true;

    // the question replaces the prompt entirely, as less's binary one
