 ...
 *
 * NOT an og option. og documents lesskey in lesskey.nro, a man page
 ...
 * undiscoverable.
 *
 * It behaves like og's -? rather than like --help output: the page is
...
export const lesskeyHelp: OptionSpec = {
    ...
    defaultValue: 0,
    get: () => 0,
    // typed at the runtime `-` prompt this OPENS the page, where og's
    // -? can only say "Use h for help": og's help is reachable by key,
