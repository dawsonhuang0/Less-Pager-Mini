...
| F87 | `2673`+`2674`+`2670`+`2671` | Unicode: emoji modifiers DELETED from output (not shown as hex), VS15 discarding a shifted-off double-width placeholder, more chars treated as binary. | ? `charset.c` is still UNREAD in the og-read-ledger; this is the concrete part of that gap. |
